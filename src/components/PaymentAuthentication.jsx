  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row gap-[45px] p-4 sm:p-9 justify-between">
      ...
      <div className="flex items-center flex-col w-full lg:w-1/2 justify-start">
        <div>
          <h2 className="p-2 font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[40px] text-[#000000] text-center lg:text-left">
            Let’s Make Payment
          </h2>
          <p className="font-normal sm:text-lg md:text-xl lg:text-2xl text-[#575757] mt-6 sm:mt-10 text-center lg:text-left">
        ...
        <div className="bg-white p-4 rounded-3xl my-12 sm:my-24 border-[1px] border-[#9FC9A8]">
          <GenerateQr qrValue="https://example.com" width={300} height={300} />
        </div>
